...
struct ControlPanel: View {
    ...
    private func localizedColor(_ color: String, forLanguage language: String) -> String {
        ...
        let translations: [String: String] = [
            "42mm": "42毫米",
            "46mm": "46毫米",
            "Aluminum Jet Black + Sport Band Black": "曜石黑色铝金属表壳 + 黑色运动表带",
            "Aluminum Jet Black + Sport Loop Dark Gray": "曜石黑色铝金属表壳 + 暗灰色回环式运动表带",
            "Aluminum Rose Gold + Sport Band Light Blush": "玫瑰金色铝金属表壳 + 浅腮红运动表带",
            "Aluminum Rose Gold + Sport Loop Purple Fog": "玫瑰金色铝金属表壳 + 紫雾色回环式运动表带",
            "Aluminum Silver + Sport Band Neon Yellow": "银色铝金属表壳 + 荧光黄色运动表带",
            "Aluminum Silver + Sport Band Purple Fog": "银色铝金属表壳 + 紫雾色运动表带",
            "Aluminum Silver + Sport Loop Forest": "银色铝金属表壳 + 森林绿色回环式运动表带",
            "Aluminum Silver + Sport Loop Neon Yellow": "银色铝金属表壳 + 荧光黄色回环式运动表带",
            "Aluminum Space Gray + Sport Band Anchor Blue": "深空灰色铝金属表壳 + 深蓝色运动表带",
            "Aluminum Space Gray + Sport Band Black": "深空灰色铝金属表壳 + 黑色运动表带",
            "Aluminum Space Gray + Sport Loop Anchor Blue": "深空灰色铝金属表壳 + 深蓝色回环式运动表带",
            "Aluminum Space Gray + Sport Loop Forest": "深空灰色铝金属表壳 + 森林绿色回环式运动表带",
            "Black": "黑色",
            ...
            "Starlight": "星光色",
            "Teal": "深青色",
            "Titanium Gold + Magnetic Link Sage Gray": "金色钛金属表壳 + 鼠尾草灰磁力回环形表带",
            "Titanium Gold + Milanese Loop": "金色钛金属表壳 + 米兰尼斯表带",
            "Titanium Gold + Sport Band Light Blush": "金色钛金属表壳 + 浅腮红运动表带",
            "Titanium Gold + Sport Band Purple Fog": "金色钛金属表壳 + 紫雾色运动表带",
            "Titanium Natural + Magnetic Link Caramel": "原色钛金属表壳 + 焦糖色磁力回环形表带",
            "Titanium Natural + Milanese Loop": "原色钛金属表壳 + 米兰尼斯表带",
            "Titanium Natural + Sport Band Stone Gray": "原色钛金属表壳 + 石灰色运动表带",
            "Titanium Slate + Magnetic Link Navy": "石板色钛金属表壳 + 海军蓝磁力回环形表带",
            "Titanium Slate + Milanese Loop": "石板色钛金属表壳 + 米兰尼斯表带",
            "Titanium Slate + Sport Band Black": "石板色钛金属表壳 + 黑色运动表带",
            "Ultramarine": "群青色",
            "White": "白色",
